...
// ResponsesClientYaml struct for ResponsesClientYaml
type ResponsesClientYaml struct {
	// Unique client login.
	Login string `json:"login"`
	// Client state:  * Active if `true` * Inactive if `false`  If inactive, the client cannot get authentication tokens (JWTs).
